...
const RevealList: React.FC<RevealListType> = ({ children, className, interval, origin, distance, duration, delay, reset, easing, opacity, rotate, scale, cleanup, desktop, mobile, useDelay, viewFactor, viewOffset, }) => {
