...
const RevealWrapper: React.FC<RevealWrapperType> = ({ children, className, origin, distance, duration, delay, reset, easing, opacity, rotate, scale, cleanup, desktop, mobile, useDelay, viewFactor, viewOffset, }) => {
    ...
    useEffect(() => {
        async function revElement() {
            ...
            else if(ref.current) { //if you don't pass any props
